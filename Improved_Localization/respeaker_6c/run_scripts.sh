...
start powershell -Command "cd 'C:\Users\bhpar\Desktop\CS\Sound-Project\Improved_Localization\respeaker_6c'; bash -i record.sh 2 3 $START_TIME; bash -i record.sh 3 2 $START_TIME; pause"
